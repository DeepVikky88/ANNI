...
from PURVIMUSIC import HELPABLE, Telegram, YouTube, app
from PURVIMUSIC.misc import SUDOERS, _boot_
from PURVIMUSIC.plugins.play.playlist import del_plist_msg
...
"""
        ...
        try:
            ...
            await vip.edit_text(f"**𝗪𝗘𝗟𝗖**")
            await vip.edit_text(f"**𝗪𝗘𝗟𝗖𝗢**")
            await vip.edit_text(f"**𝗪𝗘𝗟𝗖𝗢𝗠𝗘**")

            await vip.delete()
            vips = await message.reply_text("**𝗧𝗛**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**𝗧𝗛𝗔𝗡**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗧𝗛𝗔𝗡𝗞𝗦**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**𝗧𝗛𝗔𝗡𝗞𝗦 𝗙𝗢**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗧𝗛𝗔𝗡𝗞𝗦 𝗙𝗢𝗥**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗦𝗧**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗦𝗧𝗔𝗥**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗦𝗧𝗔𝗥𝗧𝗜**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗦𝗧𝗔𝗥𝗧𝗜𝗡𝗚.**")
            await asyncio.sleep(0.1)
